    ...
    <main className="daily-page standalone">
      ...
      <section className="daily-admin-page">
        ...
        <div className="daily-admin-card">
          ...
          <div className="daily-subpanel literature-cdk-panel literature-cdk-link-panel">
            <div className="daily-section-head">
              <div>
                <h3>公开文献检索 CDK</h3>
                <p className="daily-hint">CDK 已拆分到独立管理页，支持批量生成、批量复制、批量修改和实时停用。</p>
              </div>
              <a className="btn btn-ghost daily-test-btn" href="/admin/CDK">打开 CDK 管理</a>
            </div>
          </div>
        ...
        <div className="daily-admin-card daily-admin-actions">
          ...
          <a className="btn btn-ghost" href="/admin/CDK">CDK 管理</a>
