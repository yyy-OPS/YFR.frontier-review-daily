...
class Settings:
    ...
    llm_timeout_seconds: float = float(os.environ.get("LLM_TIMEOUT_SECONDS", "900"))
    llm_connect_timeout_seconds: float = float(os.environ.get("LLM_CONNECT_TIMEOUT_SECONDS", "20"))
    llm_complete_use_stream: bool = _env_bool("LLM_COMPLETE_USE_STREAM", True)
